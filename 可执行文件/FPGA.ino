...
char WIFI_SSID[]="ChinaNet-F6FD92";
char WIFI_PASSWORD[]="132920050";
char HOST_ADDRESS[]="a3apxi662ixelc-ats.iot.us-east-1.amazonaws.com";
...
void loop()
{
    ...
    */
    if(tick >= 3)   // publish to topic every ?seconds
    {
        tick=0;
        //result in lot
